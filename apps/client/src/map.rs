...
/// The default skirmish scenario (the hand-written template), baked into the
/// binary. Used on the Earthlike heightmap; every voxel world carries its
/// own fitted copy below.
pub const SKIRMISH: &str = include_str!("../../../assets/maps/crossfire_basin.map");

/// Per-world scenarios generated by `assets/worldgen/bake.py` (in
/// `voxel::MAPS` order): the template re-fitted onto each world's viable
/// ground, so spawns and clusters sit on naturally playable terrain instead
/// of the terrain being re-carved to fit the template.
const WORLD_SCENARIOS: [&str; 22] = [
    include_str!("../../../assets/maps/moon.map"),
    include_str!("../../../assets/maps/ceres.map"),
    include_str!("../../../assets/maps/vesta.map"),
    include_str!("../../../assets/maps/mars.map"),
    include_str!("../../../assets/maps/callisto.map"),
    include_str!("../../../assets/maps/ganymede.map"),
    include_str!("../../../assets/maps/europa.map"),
    include_str!("../../../assets/maps/io.map"),
    include_str!("../../../assets/maps/titan.map"),
    include_str!("../../../assets/maps/enceladus.map"),
    include_str!("../../../assets/maps/triton.map"),
    include_str!("../../../assets/maps/rhea.map"),
    include_str!("../../../assets/maps/iapetus.map"),
    include_str!("../../../assets/maps/dione.map"),
    include_str!("../../../assets/maps/titania.map"),
    include_str!("../../../assets/maps/oberon.map"),
    include_str!("../../../assets/maps/umbriel.map"),
    include_str!("../../../assets/maps/ariel.map"),
    include_str!("../../../assets/maps/miranda.map"),
    include_str!("../../../assets/maps/pluto.map"),
    include_str!("../../../assets/maps/chiron.map"),
    include_str!("../../../assets/maps/earth.map"),
];

/// The scenario for the active battlefield: the world-fitted layout when a
/// voxel map is selected, the hand-written template otherwise.
pub fn active_scenario() -> &'static str {
    match crate::voxel::active_index() {
        Some(i) => WORLD_SCENARIOS[i],
        None => SKIRMISH,
    }
}
