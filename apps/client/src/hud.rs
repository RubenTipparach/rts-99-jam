...
// gunmetal plating for the two wings and the stretchable centre strip.
#[cfg(target_arch = "wasm32")]
const SKIN_WING_L: usize = 100;
#[cfg(target_arch = "wasm32")]
const SKIN_WING_R: usize = 101;
#[cfg(target_arch = "wasm32")]
const SKIN_MID: usize = 102;

#[cfg(target_arch = "wasm32")]
fn png_bytes(key: usize) -> &'static [u8] {
    match key {
        SKIN_WING_L => include_bytes!("../../../assets/hud/wing_left.png"),
        SKIN_WING_R => include_bytes!("../../../assets/hud/wing_right.png"),
        SKIN_MID => include_bytes!("../../../assets/hud/console_mid.png"),
        i => ICON_PNGS[i],
    }
}
...
pub fn draw(
    ...
    ctx.close_path();
    ctx.fill();
    // Console skin: procedural gunmetal plating (assets/gen_hud_skin.py)
    // stretched into each section. The fill above stays as the fallback if
    // a panel fails to decode.
    ...
    skin(SKIN_WING_L, 0.0, hf - HUD_H, div_l, HUD_H);
    skin(SKIN_WING_R, div_r, hf - HUD_H, wf - div_r, HUD_H);
    skin(SKIN_MID, div_l, hf - MID_H, div_r - div_l, MID_H);
