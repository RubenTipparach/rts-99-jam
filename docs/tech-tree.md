...
| **Superweapon** | **Radiation Bloom**: permanently irradiates terrain (heals Astros, harms others) | **Nuclear Strike**: one devastating blast |
| **Detection** | **Seeing-Eye** research (units gain detection) | **Radar Array** building (scan + passive) |
...
| Resource | Source | Astromancers use it for | Hollowmen use it for |
|---|---|---|---|
...
- **Mana is spent, Power is drawn.** Mana is a stockpile you draw down (a cast
  empties it, shields refill from it). Power is a supply you must not
  over-subscribe (build past your Reactors and everything browns out); it is
  never used up.

Your worker (Acolyte / Engineer) gathers the three mined resources from nodes.
Energy is never gathered: it is produced by buildings, so adding it needs no
harvesting code, only per-building income (Mana) or a supply-vs-demand tally
(Power).
...
- **Costs** are illustrative starting points to tune, anchored to the sim's
  current `TRAIN_COST = 50` and `STARTING_ORE = 200`. They are spelled out
  (`150 ore, 50 carbon`). Power is written in parentheses: `(3 power)` is an
  upkeep **draw**, `(+15 power)` is supply a Reactor **adds**. Mana and Power
  never appear on the same sheet.
...
|---|---|---|---|---|
| **Spire** (HQ) | 1 | - | Acolyte; small Mana trickle; tech root | 400 ore, 50 water |
| **Reliquary** | 1 | Spire | Mana income (water-fed); gates the arcane prong | 150 ore, 50 water |
| **Sanctum** | 1 | Spire | Magus, Shield-Knight | 150 ore, 25 carbon |
| **Ward** | 1 | Spire | Static aether turret (base defense) | 75 ore |
| **Crucible** | 2 | Sanctum | Golem, Hover-tank | 200 ore, 50 carbon |
| **Conservatory** | 2 | Reliquary | Shield / regen / radiation / detection research | 150 ore, 50 mana |
| **Aerie** | 3 | Crucible | Hover-craft, Dragon | 200 ore, 75 carbon, 50 mana |
| **Citadel** | 3 | Crucible + Conservatory | Top defense; researches Uproot -> Flying Fortress | 250 ore, 50 carbon, 100 mana |
| **Ley Nexus** | 3 | Conservatory | Big Mana income; researches the Radiation Bloom superweapon | 300 ore, 100 water, 150 mana |

### Units

| Unit | Built at | Requires | Role and counters | Cost | Build |
|---|---|---|---|---|---|
| **Acolyte** | Spire | - | Worker. Gathers ore / carbon / water. Plants a structure-seed and walks away; it grows unattended (long grow time). Cannot repair. | 50 ore | 12s |
| **Magus** | Sanctum | - | Line caster infantry, aether-bolts (spends Mana per volley). Strong vs clustered infantry; folds inside a null-field. | 50 ore, 25 mana | 18s |
| **Shield-Knight** | Sanctum | - | Staple frontline mech-suit with a **regenerating shield** (refills from your Mana pool). Tanks small-arms; shield is switched off by Hollowmen null-fields. | 100 ore, 25 carbon, 25 mana | 24s |
| **Golem** | Crucible | - | Grown bruiser, huge HP, **no shield** (so null-fields do not touch it). Slow. Soaks damage and breaks lines; kited by ranged. | 150 ore, 75 carbon | 30s |
| **Hover-tank** | Crucible | - | Fast hovering armor, arcane cannon. Skirmish and raid; the mobile damage core. Light armor for its tier. | 150 ore, 50 carbon, 25 mana | 28s |
| **Hover-craft** | Aerie | - | Skirmisher gunship. Cheap-ish air harass and scouting; dies to dedicated anti-air. | 125 ore, 25 carbon, 25 mana | 26s |
| **Dragon** | Aerie | - | Tech-outfitted drake, laser breath. Air superiority and bomber. Expensive centerpiece; shielded, regenerates between fights. | 200 ore, 150 carbon, 100 mana | 44s |

### Research and upgrades

| Research | At | Requires | Effect | Cost |
|---|---|---|---|---|
| **Ley-Attunement** | Reliquary | - | +Mana income per Reliquary (compounds the arcane economy). | 100 ore, 50 water |
| **Greater Bolts** | Sanctum | Conservatory | Magus aether-bolt damage and range up. | 100 ore, 75 mana |
| **Aegis Shells** | Conservatory | - | +shield capacity on every shielded unit (Shield-Knight, Hover-tank, Dragon). | 150 ore, 100 mana |
| **Quickening** | Conservatory | - | +shield and HP regeneration rate for all units. | 150 ore, 100 mana |
| **Irradiation Adept** | Conservatory | - | Units heal faster and deal more damage while standing in irradiated terrain. | 150 ore, 50 water, 150 mana |
| **Seeing-Eye** | Conservatory | - | Grants **detection** (reveals cloak / stealth) to a chosen unit class. The answer to the Ninefold. | 150 ore, 75 mana |
| **Golem-weave** | Crucible | Conservatory | +Golem max HP; +Hover-tank cannon damage. | 150 ore, 75 carbon |
| **Uproot** | Citadel | - | The Citadel can lift into a **Flying Fortress**: slow mobile temple with heavy guns, then re-root elsewhere. | 200 ore, 150 mana |
| **Radiation Bloom** | Ley Nexus | - | Unlocks the superweapon: irradiate a target area, permanently. Astros there heal and hit harder; everyone else suffers. Big Mana cost per use, long recharge. | 300 ore, 100 water, 250 mana |
...
graph TD
    ...
    Refinery["Refinery<br/>tier 1 - ore/carbon"]
...
| Building | Tier | Requires | Unlocks (summary) | Cost |
|---|---|---|---|---|
| **Command HQ** | 1 | - | Engineer; tech root | 400 ore |
| **Refinery** | 1 | HQ | Ore and carbon processing (income) | 125 ore |
| **Reactor** | 1 | HQ | Power supply (water-cooled); gates advanced production | 150 ore, 50 water (+15 power) |
| **Barracks** | 1 | HQ | Powered-Armor Trooper, Dampener Team | 125 ore (2 power) |
| **Factory** | 2 | Reactor | Main Battle Tank; mounts add-ons | 200 ore, 50 carbon (3 power) |
| **Machine Shop** | 2 | Factory | Add-on: unlocks War-Mech and vehicle research | 100 ore, 25 carbon (1 power) |
| **Radar Array** | 2 | Reactor | Detection (scan + passive); the anti-stealth answer | 150 ore (2 power) |
| **Null Pylon** | 2 | Reactor | Static anti-magic zone (enemy casting and shields fail nearby) | 125 ore, 25 carbon (3 power) |
| **Starport** | 3 | Factory | Gunship, Dropship | 200 ore, 75 carbon (3 power) |
| **Fusion Reactor** | 3 | Factory | Much more Power; gates tier 3 | 250 ore, 100 water (+30 power) |
| **Drydock** | 3 | Starport + Fusion | Capital Warship | 300 ore, 100 carbon (5 power) |
| **Missile Silo** | 3 | Fusion | Builds and launches the Nuke | 400 ore, 50 carbon (4 power) |

### Units

| Unit | Built at | Requires | Role and counters | Cost | Build |
|---|---|---|---|---|---|
| **Engineer** | Command HQ | - | Worker. Gathers ore / carbon / water. Drives a construction rig (must stay on site; fast build) and **repairs** vehicles and buildings. | 50 ore | 10s |
| **Powered-Armor Trooper** | Barracks | - | Durable line infantry, laser rifle. The cheap, fast backbone; massed in numbers, melts to splash. | 50 ore | 14s |
| **Dampener Team** | Barracks | Radar Array | Projects a mobile **null-field**: enemy casting fails and magic shields drop inside it. Fragile; the hard counter to Astromancers. | 100 ore, 25 carbon | 22s |
| **Main Battle Tank** | Factory | - | The armor backbone; strong direct fire. Anchors a push; vulnerable to air and flanking. | 150 ore, 50 carbon | 26s |
| **War-Mech** | Factory | Machine Shop | Heavy walker, anti-everything brawler. The premier ground unit; expensive, slow to replace by Hollowmen standards. | 250 ore, 100 carbon | 38s |
| **Gunship** | Starport | - | Laser air support, anti-ground and light anti-air. Mobile firepower; dies to massed dedicated AA. | 175 ore, 50 carbon | 28s |
| **Dropship** | Starport | - | Troop and vehicle transport. Enables drops and rapid redeploys; unarmed. | 150 ore, 25 carbon | 24s |
| **Capital Warship** | Drydock | - | The big ship: heavy laser batteries. Slow, devastating, a huge investment; focus-fired or out-maneuvered. | 500 ore, 150 carbon | 60s |

### Research and upgrades

| Research | At | Requires | Effect | Cost |
|---|---|---|---|---|
| **Focusing Lenses** | Barracks | - | +Trooper and Dampener laser damage. | 100 ore |
| **Combat Stims** | Barracks | Machine Shop | Temporary fire-rate and move-speed boost, paid in HP. Aggressive timing tech. | 100 ore, 25 carbon |
| **Null Saturation** | Barracks | Radar Array | Bigger, stronger null-field radius on Dampener Teams and Null Pylons. | 150 ore, 25 carbon |
| **Composite Plating** | Machine Shop | - | +armor on all vehicles. | 125 ore, 25 carbon |
| **Siege Mode** | Machine Shop | - | Tanks can deploy into long-range siege artillery (cannot move while deployed). | 150 ore, 25 carbon |
| **Sensor Net** | Radar Array | - | +passive detection radius; reveals more of the map around your forces. | 100 ore |
| **Scanner Sweep** | Radar Array | - | Active ability: briefly reveal any area (anti-stealth, anti-fog scouting). | 100 ore |
| **Afterburners** | Starport | - | +air unit move speed. | 125 ore, 25 carbon |
| **Load Balancing** | Reactor | Fusion Reactor | Reduces Power upkeep across all buildings (run more at once). | 150 ore |
| **Nuclear Strike** | Missile Silo | - | Builds a Nuke (long build, high ore + carbon); launch designates a target for a single devastating blast. | 500 ore, 100 carbon per nuke |
...
Ship **two resources, not five**: keep mined **Ore** (already there) and add only
the faction **energy** (Mana for Astromancers, Power for Hollowmen), because both
are building-generated and need no harvesting code. Defer Carbon and Water (and
their nodes / gather logic) to a later pass.

- **Astromancers:** Spire, Reliquary, Sanctum -> Acolyte, Magus, Shield-Knight,
  with Magus bolts and Shield-Knight shields both drawing on the Mana pool.
