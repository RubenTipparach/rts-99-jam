...
> **Theme: space and magic.** A thousand-year-old secret breaks open in the
> 1950s, and a hidden people of wizards rides modern technology off a dying
> Earth and out across the solar system - with the rest of humanity scrambling
> after them. Two centuries later their descendants, now scattered from the gas
> giants to the asteroid belt, are sliding into another war.

**Logline.** When wizards stop hiding, they don't take over the world - they
*leave* it. *(working setting: 2157, the eve of the next war.)*
...
- **★ Aether & Ash** - the magical medium and the scorched Earth it left
...
- **Thaumatech** - thaumaturgy (miracle-working) fused with technology; great
  flavor word even if it isn't the title.
- **Arcane Exodus** - the flight from Earth into the dark.
- **Ashen Heavens** / **Cinder & Star** - post-apocalyptic + celestial.

---

## Timeline

### The Long Secret - antiquity to 1949
For over a thousand years, wizards lived hidden among ordinary humanity, their
numbers held down by an ancient **genetic lock** laid on their bloodline in
antiquity - a curse, a covenant, or a cage, depending on who tells it. Few
were born; fewer survived discovery. Magic endured only as a whispered society.

### The Unlocking - 1950s
The secret society contracts a rising **pharmaceutical company** to do what no
spell had managed: break the millennium-old lock on their blood. It works. For
...
- **Bloodline & inheritance.** Who is "pure," who is "magicless," and the wide
  intermarried middle - the war is also about identity.
- **Technomancy.** Magic as an engineering discipline: spells that run power
  plants, lift hover-craft, and arm warheads.
- **Radiation as the wizards' element.** The weapon meant to destroy them
  became the ground they own.
- **Exodus & diaspora.** Earth is ash; everyone here is from somewhere that no
  longer exists.

## Magic & technology (notes)
...
- **Where exactly the game sits** - the opening battle of the 2157 war? A
  specific contested moon?
- **The pharmaceutical company** - does it still exist in 2157? A third power,
  a megacorp, a quiet villain?
- **Victory & tone** - conquest, exodus, reconciliation? Tragedy or triumph?
