...
| `factions/hollowmen` | war-mech inside a gear | MANU, NON MAGIA |
| `factions/rimelings` | squid with a glowing ether-eye | THE CUP, NOT THE WINE |
| `factions/ninefold` | moonlit cat under nine stars | NINE LIVES, NO MASTERS |
| `factions/warren` | rat over a tunnel network | THE MANY OUTLAST THE MIGHTY |
